(function ($, root, undefined) {
    ...
    Array.from(dateSelect).forEach(element => {
        element.addEventListener('click', (e)=> {
            ...
            // const newEvents = eventData?.events?.filter((elcat) => elcat.cat=== cat);
            ...
            if(e.target.classList.contains('day')){
                ...
                if(eventData.events.length===0){
                    ...
                    const newEvents = eventData?.events.filter((eDay) => 
                            ...
                            .map((eDay) => {
                                    ...
                                    if(eDay.day === dayEvent &&
                                        ...
                                        eDay.year === headerYears.innerHTML) {
                                            if(e.target.classList.contains("active") && eDay.cat === cat) {
                                                label.style.display='block';
                                                showEventText(eDay.description, eDay.time);
                                            }
                                        }
                            });
                }
